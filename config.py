...
NEWS_BLACKOUT_BEFORE_MINUTES = int(
    os.getenv("NEWS_BLACKOUT_BEFORE_MINUTES", "1440")
)
NEWS_BLACKOUT_AFTER_MINUTES = int(
    os.getenv("NEWS_BLACKOUT_AFTER_MINUTES", "60")
)
CALENDAR_REFRESH_MINUTES = int(os.getenv("CALENDAR_REFRESH_MINUTES", "360"))
